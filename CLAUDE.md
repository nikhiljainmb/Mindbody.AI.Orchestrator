...
- Launch the four reviewers in ONE message (four parallel Task calls) — a single
  multi-Task message is what makes them run concurrently.
...
Do not read `patterns/`, `templates/`, or `docs/` unless the current step requires them.
